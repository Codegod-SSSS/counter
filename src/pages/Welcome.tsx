    ...
    <div className="min-h-screen bg-bg-main flex items-center justify-center p-4 overflow-hidden transition-colors duration-500 relative">
      ...
      <div className="absolute top-8 right-8 flex items-center gap-4 z-20">
        <motion.div 
          ...
          className="flex bg-card/50 backdrop-blur-md p-1 rounded-2xl border border-border-subtle"
        >
        ...
        <motion.button 
          ...
          onClick={toggleTheme}
          className="p-3 bg-card/50 backdrop-blur-md rounded-2xl border border-border-subtle text-text-primary/70 hover:text-accent transition-all"
        >
        ...
        >
          ...
          <div className="space-y-4">
            <motion.h2 
              ...
              className="text-5xl lg:text-6xl font-display font-black text-text-primary leading-[1.1] tracking-tight"
            >
            ...
            <motion.p 
              ...
              className="text-lg text-text-primary/60 leading-relaxed max-w-md"
            >
              {t.subtitle}
            </motion.p>
          </div>
          ...
          <motion.div 
            ...
            className="space-y-4"
          >
            <label className="text-[10px] font-bold text-text-primary/40 uppercase tracking-widest ml-1">{t.currency}</label>
              ...
              {CURRENCIES.map((c, i) => (
                <motion.button
                  ...
                  className={`py-3 rounded-xl text-xs font-bold border-2 transition-all ${
                    ...
                    : 'border-border-subtle text-text-primary/40 hover:border-accent/40 hover:text-text-primary'
                  }`}
                >
                  {c.code}
                </motion.button>
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
            onClick={handleEnter}
            className="group flex items-center gap-3 bg-accent text-[var(--color-accent-contrast)] px-8 py-5 rounded-3xl font-display font-black text-xl shadow-2xl shadow-accent/20 hover:bg-opacity-90 transition-all"
          >
